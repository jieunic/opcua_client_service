...
class SubscribeHandler:
    ...
    async def datachange_notification(self, node, val, data):
        ...
        #         # if true_1st is None:
        #         true_1st = current_time
        #         print(true_1st)
        #     elif val[0] > 0 or val[1] > 0 or val[2] > 0 or val[3] > 0 or val[4] > 0 or val[5] > 0:
        #         try:
        #             current_time = time.time()
        #             # if true_1st != 0:
        #             time_diff = current_time - true_1st
        #             print(time_diff)
        #             true_1st = 0
        ...
        if isinstance(val, list):
            if val[0] == 0 and val[1] == 0 and val[2] == 0 and val[3] == 0 and val[4] == 0 and val[5] == 0:
                current_time = time.time()
                if true_1st is None:  # Cek apakah true_1st belum diinisialisasi
                    true_1st = current_time
                    print(true_1st)
            elif val[0] > 0 or val[1] > 0 or val[2] > 0 or val[3] > 0 or val[4] > 0 or val[5] > 0:
                try:
                    current_time = time.time()
                    if true_1st is not None:  # Cek apakah true_1st sudah diinisialisasi
                        time_diff = current_time - true_1st
                        print(time_diff)
                        true_1st = None  # Reset true_1st setelah digunakan
                except UnboundLocalError as e:
                    print(f"ERR: {e}")
